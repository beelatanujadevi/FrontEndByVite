...
const srcFolder = "SrcMazer";
const distFolder = "publicDir/Mazer";

import sidebarItems from "./SrcMazer/sidebar-items.json";
import horizontalMenuItems from "./SrcMazer/horizontal-menu-items.json";
